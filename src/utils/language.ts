...
export const TRANSLATIONS = {
  ...
  ru: {
    ...
    timeRemaining: 'Время до окончания',
    fasterMining: 'быстрее майнинг',
    
    // ... keep existing code (rest of Russian translations)
  ...
  hi: {
    ...
    miningSpeed: 'माइनिंग स्पीड',
    startMining: 'माइनिंग शुरू करें',
    stopMining: 'माइनिंग बंद करें',
    upgradeMiningSpeed: 'माइनिंग स्पीड अपग्रेड करें',
    timeRemaining: 'शेष समय',
    fasterMining: 'तेज़ माइनिंग',
  ...
  es: {
    ...
    upgradeMiningSpeed: 'Mejorar Velocidad de Minería',
  ...
  de: {
    ...
    upgradeMiningSpeed: 'Mining-Geschwindigkeit Verbessern',
  ...
  ja: {
    ...
    wallet: 'ウォレット',
    friends: '友達',
    spaceBalance: '$SPACE残高',
    miningSpeed: 'マイニング速度',
    startMining: 'マイニング開始',
    stopMining: 'マイニング停止',
    upgradeMiningSpeed: 'マイニング速度アップグレード',
    timeRemaining: '残り時間',
    fasterMining: 'より高速なマイニング',
  ...
  pt: {
    ...
    upgradeMiningSpeed: 'Melhorar Velocidade de Mineração',
