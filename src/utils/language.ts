...
const translations: Record<string, string> = {
  ...
  'connectWalletDesc': 'Connect your TON wallet',
  'firstMine': 'First Mine',
  'firstMineDesc': 'Start mining for the first time',
  'completeProfile': 'Complete Profile',
  'completeProfileDesc': 'Complete your profile information',
  'joinTelegram': 'Join Telegram',
  'joinTelegramDesc': 'Join our official Telegram channel',
  'followTwitter': 'Follow Twitter',
  'followTwitterDesc': 'Follow our official Twitter account',
  'subscribeYoutube': 'Subscribe YouTube',
  'subscribeYoutubeDesc': 'Subscribe to our official channel',
  'dailyLogin': 'Daily Login',
  'dailyLoginDesc': 'Login daily to earn rewards',
  'dailyMine': 'Daily Mining',
  'dailyMineDesc': 'Mine for 30 minutes daily',
  'dailyShare': 'Daily Share',
  'dailyShareDesc': 'Share the app with friends',
  'basicTasks': 'Basic',
