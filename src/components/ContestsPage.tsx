...
const ContestsPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-pink-950 p-3 pb-20">
      <div className="max-w-md mx-auto space-y-4">
        ...
        <div className="text-center mb-6 relative">
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center mb-3">
              <div className="p-3 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-full shadow-2xl animate-pulse-glow">
                <Trophy className="w-6 h-6 text-white" />
              </div>
            </div>
            <h1 className="text-3xl bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent mb-2 font-bold">
              {t('contests') || 'Contests'}
            </h1>
            <p className="text-sm leading-relaxed text-zinc-50 font-medium">
        ...
        <Card className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-xl border-2 border-blue-500/30 rounded-2xl overflow-hidden bg-indigo-900">
          ...
          <CardContent className="space-y-3 p-4 pt-0 bg-indigo-900">
            ...
            <div className="bg-white/5 rounded-xl p-3">
              <p className="text-gray-300 text-xs text-center mb-2">{t('timeLeft') || 'Time Left'}</p>
              <div className="flex justify-center items-center gap-1 text-white">
                <div className="text-center">
                  <div className="text-lg font-bold text-blue-400">{timeLeft.hours.toString().padStart(2, '0')}</div>
                  <div className="text-xs text-gray-400">{t('hours') || 'Hours'}</div>
                </div>
                <div className="text-blue-400 text-lg">:</div>
                <div className="text-center">
                  <div className="text-lg font-bold text-blue-400">{timeLeft.minutes.toString().padStart(2, '0')}</div>
                  <div className="text-xs text-gray-400">{t('minutes') || 'Minutes'}</div>
                </div>
                <div className="text-blue-400 text-lg">:</div>
                <div className="text-center">
                  <div className="text-lg font-bold text-blue-400">{timeLeft.seconds.toString().padStart(2, '0')}</div>
        ...
        <Card className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 backdrop-blur-xl border-2 border-yellow-500/30 rounded-2xl overflow-hidden bg-violet-800">
          ...
          <CardContent className="space-y-3 p-4 pt-0 bg-violet-800">
            ...
            <div className="bg-white/5 rounded-xl p-3">
              ...
              <div className="flex justify-center items-center gap-1 text-white">
                <div className="text-center">
                  <div className="text-lg font-bold text-yellow-400">{weeklyTimeLeft.days}</div>
                  <div className="text-xs text-gray-400">{t('days') || 'Days'}</div>
                </div>
                <div className="text-yellow-400 text-lg">:</div>
                <div className="text-center">
                  <div className="text-lg font-bold text-yellow-400">{weeklyTimeLeft.hours.toString().padStart(2, '0')}</div>
                  <div className="text-xs text-gray-400">{t('hours') || 'Hours'}</div>
                </div>
                <div className="text-yellow-400 text-lg">:</div>
                <div className="text-center">
                  <div className="text-lg font-bold text-yellow-400">{weeklyTimeLeft.minutes.toString().padStart(2, '0')}</div>
                  <div className="text-xs text-gray-400">{t('minutes') || 'Minutes'}</div>
                </div>
              </div>
            </div>
            ...
            {/* Last Winner */}
            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-xl p-3 text-center">
              <p className="text-gray-300 text-xs mb-1">{t('lastWeekWinner') || 'Last Week Winner'}</p>
        ...
        {/* Contest Rules */}
        <Card className="bg-gradient-to-br from-gray-500/10 to-slate-500/10 backdrop-blur-xl border-2 border-gray-500/30 rounded-2xl overflow-hidden">
          ...
          <CardContent className="p-4 pt-0">
            <div className="space-y-2 text-xs text-gray-300">
              ...
              <div className="flex items-start gap-2">
                <div className="w-5 h-5 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-0.5">4</div>
