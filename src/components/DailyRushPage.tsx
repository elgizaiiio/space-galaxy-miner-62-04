              ...
              <Card 
                className={`h-full w-full cursor-pointer transition-all duration-200 ${
                  isClaimed
                    ...
                    : isUnlocked
                      ? `bg-gradient-to-br ${theme.primaryColor} border-white/30 hover:scale-105`
              ...
              >
                <CardContent className="p-1 h-full flex flex-col items-center justify-center">
                  ...
                  {ticket.type === 'paid' && !isClaimed && (
                    <div className="text-xs text-yellow-400">{ticket.cost} TON</div>
                  )}
                </CardContent>
              </Card>
            </motion.div>
      ...
      <div className="max-w-md mx-auto relative z-10">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Button 
            ...
            className="bg-gray-600/20 border-gray-400/30 text-white hover:bg-gray-600/30"
          >
