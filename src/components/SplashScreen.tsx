        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            {[...Array(8)].map((_, i) => (
              <motion.div
                key={`ray-${i}`}
                className="absolute bg-gradient-to-r from-transparent via-blue-400 to-transparent h-0.5 opacity-30"
                style={{
                  width: '200px',
                  left: `${Math.random() * 100}%`,
                  top: `${Math.random() * 100}%`,
          ...
          <AnimatePresence>
            {currentPhase >= 2 && (
              ...
              >
                <motion.p
                  className="text-xl text-blue-200 font-medium max-w-md px-4 leading-relaxed"
                  animate={{
                    opacity: [0.7, 1, 0.7],
                  }}
                  transition={{
                ...
                >
                  استكشف مجرة المكافآت والكنوز الكونية
                </motion.p>
